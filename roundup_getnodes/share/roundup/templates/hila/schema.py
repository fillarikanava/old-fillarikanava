...
organisation = Class(db, "organisation",
                order=Number(),
                name=String(),
                logo=Link("file"),
                css=String(),
...
msg = FileClass(db, "msg",
                ...
                inreplyto=String(),
                language=Link('language'),
                votes=Multilink('vote', do_journal='no'), 
                places=Multilink("place", do_journal='no'),
                )
...
#SHA: 8a197535b5452cd8e7712b4b0ff210ed19f380f3
