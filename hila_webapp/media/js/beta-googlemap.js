...
function loadNewEvents(json_url, template, previewtemplate, clustertemplate, data) 
{
	...
	else
	{
		...
		$.ajax({
			...
			currentLoadedData = data[0]["seqnum"];
			...
			if (issues[1])
			{
				$.each(issues[1], function(i, issue_data) {
