...
from hila.facebookconnect.models import FacebookTemplate,FacebookProfile
...
def show_logout():
    ...
    log_out = _('Log out')
    return '<a href="%s" onclick="FB.Connect.logoutAndRedirect(\'%s\');return false;">%s</a>' % (o,o,log_out) #hoot!
